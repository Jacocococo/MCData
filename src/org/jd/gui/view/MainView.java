...
public class MainView<T extends JComponent & UriGettable> implements UriOpenable, PreferencesChangeListener {
    ...
    public MainView(
        ...
        invokeLater(() -> {
            ...
            IconButton findNextButton = new IconButton("Next", newAction(new ImageIcon(MainView.class.getResource("/org/jd/gui/images/next_nav.png")), true, findNextActionListener));
            toolBar.add(findNextButton);

            toolBar.add(Box.createHorizontalStrut(5));

            IconButton findPreviousButton = new IconButton("Previous", newAction(new ImageIcon(MainView.class.getResource("/org/jd/gui/images/prev_nav.png")), true, findPreviousActionListener));
            ...
            findCloseButton.setIcon(new ImageIcon(MainView.class.getResource("/org/jd/gui/images/close.gif")));
            findCloseButton.setRolloverIcon(new ImageIcon(MainView.class.getResource("/org/jd/gui/images/close_active.gif")));
            ...
            Action openAction = newAction("Open File...", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/open.png")), true, "Open a file", openActionListener);
            closeAction = newAction("Close", false, closeActionListener);
            Action saveAction = newAction("Save", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/save.png")), false, saveActionListener);
            Action saveAllSourcesAction = newAction("Save All Sources", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/save_all.png")), false, saveAllSourcesActionListener);
            Action exitAction = newAction("Exit", true, "Quit this program", exitActionListener);
            Action copyAction = newAction("Copy", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/copy.png")), false, copyActionListener);
            Action pasteAction = newAction("Paste Log", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/paste.png")), true, pasteActionListener);
            ...
            openTypeAction = newAction("Open Type...", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/open_type.png")), false, openTypeActionListener);
            ...
            backwardAction = newAction("Back", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/backward_nav.png")), false, backwardActionListener);
            forwardAction = newAction("Forward", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/forward_nav.png")), false, forwardActionListener);
            Action searchAction = newAction("Search...", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/search_src.png")), false, searchActionListener);
            ...
            Action preferencesAction = newAction("Preferences...", new ImageIcon(MainView.class.getResource("/org/jd/gui/images/preferences.png")), true, "Open the preferences panel", preferencesActionListener);
